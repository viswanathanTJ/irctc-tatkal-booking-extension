...
window.addEventListener("load", () => {
  ...
  document
    .querySelector("#from-station-input")
    .addEventListener("focusout", setFromStationValue);
  document
    .querySelector("#destination-station-input")
    .addEventListener("keyup", destinationStationFilter);
  document
    .querySelector("#from-station-input")
    .addEventListener("focusout", setDestinationStationValue);
  document
...
function setFromStationValue(e) {
  finalData["journey_details"]["from"] = {
    value: e.target.value
  };
}
function setDestinationStationValue(e) {
